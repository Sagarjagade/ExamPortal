...
today = mm + '-' + dd + '-' + yyyy;
  ...
  TableExport.prototype = {
    ...
    defaults: {
      ...
      filename: "Tracker_Attendance", // (id, String), filename for the downloaded file, (default: 'id')
      ...
      sheetname: "Tracker_Attendance_" // (id, String), sheet name for the exported spreadsheet, (default: 'id')
    },
    /**
     * Constants
     * @memberof TableExport.prototype
